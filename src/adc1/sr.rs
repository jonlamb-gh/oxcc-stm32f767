...
impl From<JSTRT_A> for bool {
    ...
    fn from(variant: JSTRT_A) -> Self {
        match variant {
            JSTRT_A::NOTSTARTED => false,
            JSTRT_A::STARTED => true,
        }
    }
}
...
impl From<JEOC_A> for bool {
    ...
    fn from(variant: JEOC_A) -> Self {
        match variant {
            JEOC_A::NOTCOMPLETE => false,
            JEOC_A::COMPLETE => true,
        }
    }
}

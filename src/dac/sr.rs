...
pub enum DMAUDR2_A {
    ...
    NOUNDERRUN,
    #[doc = "1: DMA underrun error condition occurred for DAC channel2"]
    UNDERRUN,
}
impl From<DMAUDR2_A> for bool {
    ...
    fn from(variant: DMAUDR2_A) -> Self {
        match variant {
            DMAUDR2_A::NOUNDERRUN => false,
            DMAUDR2_A::UNDERRUN => true,
        }
    }
}
...
pub enum DMAUDR1_A {
    ...
    NOUNDERRUN,
    #[doc = "1: DMA underrun error condition occurred for DAC channel1"]
    UNDERRUN,
}
impl From<DMAUDR1_A> for bool {
    ...
    fn from(variant: DMAUDR1_A) -> Self {
        match variant {
            DMAUDR1_A::NOUNDERRUN => false,
            DMAUDR1_A::UNDERRUN => true,
        }
    }
}

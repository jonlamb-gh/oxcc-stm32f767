...
impl From<PINCOS_A> for bool {
    ...
    fn from(variant: PINCOS_A) -> Self {
        match variant {
            PINCOS_A::PSIZE => false,
            PINCOS_A::FIXED4 => true,
        }
    }
}
...
impl<'a> MSIZE_W<'a> {
    ...
    pub fn byte(self) -> &'a mut W {
        self.variant(MSIZE_A::BYTE)
    }
    #[doc = "Half-word (16-bit)"]
    #[inline(always)]
    pub fn half_word(self) -> &'a mut W {
        self.variant(MSIZE_A::HALFWORD)
    }
    #[doc = "Word (32-bit)"]
    #[inline(always)]
    pub fn word(self) -> &'a mut W {
        self.variant(MSIZE_A::WORD)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl From<DIR_A> for u8 {
    ...
    fn from(variant: DIR_A) -> Self {
        match variant {
            DIR_A::PERIPHERALTOMEMORY => 0,
            DIR_A::MEMORYTOPERIPHERAL => 1,
            DIR_A::MEMORYTOMEMORY => 2,
        }
    }
}
...
impl From<DMEIE_A> for bool {
    ...
    fn from(variant: DMEIE_A) -> Self {
        match variant {
            DMEIE_A::DISABLED => false,
            DMEIE_A::ENABLED => true,
        }
    }
}

...
#[doc = "Possible values of the field `DTCMRAMEN`"]
pub type DTCMRAMENR = OTGHSULPIENR;
...
#[doc = "Values that can be written to the field `DTCMRAMEN`"]
pub type DTCMRAMENW = OTGHSULPIENW;
#[doc = r" Proxy"]
...
impl<'a> _DTCMRAMENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: DTCMRAMENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }

...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPRE2_A {
    #[doc = "0: AHB clock not divided"]
    DIV1,
    #[doc = "4: AHB clock divided by 2"]
    DIV2,
    #[doc = "5: AHB clock divided by 4"]
    DIV4,
    #[doc = "6: AHB clock divided by 8"]
    DIV8,
    #[doc = "7: AHB clock divided by 16"]
    DIV16,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SW_A {
    #[doc = "0: HSI oscillator selected as system clock"]
    HSI,
    #[doc = "1: HSE oscillator selected as system clock"]
    HSE,
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SWS_A {
    #[doc = "0: HSI oscillator used as the system clock"]
    HSI,
    #[doc = "1: HSE oscillator used as the system clock"]
    HSE,
    #[doc = "2: PLL used as the system clock"]
    PLL,
}

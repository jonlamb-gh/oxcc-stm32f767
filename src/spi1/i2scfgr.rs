...
impl From<I2SMOD_A> for bool {
    ...
    fn from(variant: I2SMOD_A) -> Self {
        match variant {
            I2SMOD_A::SPIMODE => false,
            I2SMOD_A::I2SMODE => true,
        }
    }
}
...
impl From<CKPOL_A> for bool {
    ...
    fn from(variant: CKPOL_A) -> Self {
        match variant {
            CKPOL_A::IDLELOW => false,
            CKPOL_A::IDLEHIGH => true,
        }
    }
}
...
impl From<DATLEN_A> for u8 {
    ...
    fn from(variant: DATLEN_A) -> Self {
        match variant {
            DATLEN_A::SIXTEENBIT => 0,
            DATLEN_A::TWENTYFOURBIT => 1,
            DATLEN_A::THIRTYTWOBIT => 2,
        }
    }
}
...
impl From<CHLEN_A> for bool {
    ...
    fn from(variant: CHLEN_A) -> Self {
        match variant {
            CHLEN_A::SIXTEENBIT => false,
            CHLEN_A::THIRTYTWOBIT => true,
        }
    }
}
